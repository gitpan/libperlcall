...
#ifndef _JTOBEY_PERLCALL_HH
#define _JTOBEY_PERLCALL_HH
...
namespace JTobey_PerlCall
{
  ...
  typedef Scalar (*sub_one_arg) (const Scalar&);
  typedef Scalar (*sub_hashref) (const Scalar&, const Hashref&);
  typedef List (*sub) (const List&, Context);
...
#ifdef JTOBEY_PERLCALL_INTERPRETER_PRIVATE
    JTOBEY_PERLCALL_INTERPRETER_PRIVATE
#endif

  public:
    // Construct an interpreter with args "PerlCall", "-e0"
    Interpreter ();
  ...
  public:
    ...
    Scalarref& operator= (const Scalarref& r) { return *this = r; }
  ...
  public:
    ...
    Arrayref& operator= (const Arrayref& r) { return *this = r; }
  ...
  */
  ...
  public:
    ...
    Hashref& operator= (const Hashref& r) { return *this = r; }
  ...
  public:
    ...
    Coderef& operator= (const Coderef& r) { return *this = r; }
